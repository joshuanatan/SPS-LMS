...
class Validate extends CI_Controller{
    ...
    public function nilaiutama(){
        ...
        foreach($result as $a){
            ...
            if($jumlah != 0){$i .= "<tr><td>RATA-RATA QUIZ</td><td>".$a->quiz."%</td><td>".round($total/$jumlah,2)."</td>";}
            else $i .= "<tr><td>RATA-RATA QUIZ</td><td>".$a->quiz."%</td><td>0</td>";
            $i .= "<tr><td>LAB</td><td>".$a->lab."%</td><td>".$a->nilai_lab."</td>";
            $i .= "<tr><td>TUGAS</td><td>".$a->tugas."%</td><td>".$a->nilai_tugas."</td>";
            if($jumlah != 0){$i .= "<tr><td>NILAI AKHIR</td><td>".($a->tugas+$a->lab+$a->uh+$a->uts+$a->uas+$a->quiz)."%</td><td>".($a->nilai_tugas*($a->tugas/100)+$a->nilai_lab*($a->lab/100)+$a->nilai_uh*($a->uh/100)+$a->nilai_uts*($a->uts/100)+$a->nilai_uas*($a->uas/100)+round($total/$jumlah,2)*($a->quiz/100))."</td>";}
            else $i .= "<tr><td>NILAI AKHIR</td><td>".($a->tugas+$a->lab+$a->uh+$a->uts+$a->uas+$a->quiz)."%</td><td>".($a->nilai_tugas*($a->tugas/100)+$a->nilai_lab*($a->lab/100)+$ulanganharian*($a->uh/100)+$a->nilai_uts*($a->uts/100)+$a->nilai_uas*($a->uas/100)+0*($a->quiz/100))."</td>";
        }
        echo json_encode($i);
    }
    public function nilaiutamasiswa(){
        ...
        foreach($result as $a){
            ...
            $i .= "<tr><td>LAB</td><td>".$a->lab."%</td><td>".$a->nilai_lab."</td>";
            $i .= "<tr><td>TUGAS</td><td>".$a->tugas."%</td><td>".$a->nilai_tugas."</td>";
            if($jumlah != 0){$i .= "<tr><td>NILAI AKHIR</td><td>".($a->tugas+$a->lab+$a->uh+$a->uts+$a->uas+$a->quiz)."%</td><td>".($a->nilai_tugas*($a->tugas/100)+$a->nilai_lab*($a->lab/100)+$ulanganharian*($a->uh/100)+$a->nilai_uts*($a->uts/100)+$a->nilai_uas*($a->uas/100)+round($total/$jumlah,2)*($a->quiz/100))."</td>";}
            else $i .= "<tr><td>NILAI AKHIR</td><td>".($a->tugas+$a->lab+$a->uh+$a->uts+$a->uas+$a->quiz)."%</td><td>".($a->nilai_tugas*($a->tugas/100)+$a->nilai_lab*($a->lab/100)+$ulanganharian*($a->uh/100)+$a->nilai_uts*($a->uts/100)+$a->nilai_uas*($a->uas/100)+0*($a->quiz/100))."</td>";
        }
        echo json_encode($i);
    }
