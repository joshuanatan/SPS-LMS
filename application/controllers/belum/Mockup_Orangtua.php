...
class Mockup_Orangtua extends CI_Controller{
    ...
    public function req(){
        ...
        $this->load->view("mockup-orangtua/menu");
    ...
    public function index(){
        ...
        $this->load->view("mockup-orangtua/index");
        /* endnya disini */
    ...
    public function absen(){
        ...
        $this->load->view("mockup-orangtua/absen");
        /* endnya disini */
        $this->load->view("req/close-content");
        $this->load->view("req/space");
        $this->close();
