...
class Kesiswaan extends CI_Controller{
    ...
    public function req(){
        ...
        $this->load->view("mockup-kesiswaan/menu");
    ...
    public function index(){
        ...
        $this->load->view("mockup-kesiswaan/index");
        /* endnya disini */
    ...
    public function siswa(){
        ...
        $this->load->view("mockup-kesiswaan/siswa");
        /* endnya disini */
        $this->load->view("req/close-content");
        $this->load->view("req/space");
        $this->close();
    ...
    public function kelas(){
        ...
        $this->load->view("mockup-kesiswaan/kelas-siswa");
        /* endnya disini */
        $this->load->view("req/close-content");
        $this->load->view("req/space");
        $this->close();
    ...
    public function viewAll(){
        ...
        $this->load->view("mockup-kesiswaan/orangtua",$data);
    }
