...
<div class="row">
    <div class="col-xl-12"> 
        ...
        <form action="<?php echo base_url(). 'user/user/updateprofile/'.$lista->id_user;?>" method ="post">
        ...
        <div class="card">
            ...
            <tr>
                <td>Password</td>
                <td><a href="<?php echo base_url().'user/user/editpassword/'.$lista->id_user?>"><input class="btn btn-warning" style="width:190px" type="button" value="EDIT"></a></td>
            </tr>    
            <tr>
